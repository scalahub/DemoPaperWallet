...
ThisBuild / scmInfo := Some(
  ScmInfo(
    url("https://github.com/scalahub/DemoPaperWallet"),
    "scm:git@github.scalahub/DemoPaperWallet.git"
  )
)
...
ThisBuild / description := "Demo example of paper wallet"
ThisBuild / licenses := List(
  "The Unlicense" -> new URL("https://unlicense.org/")
)
ThisBuild / homepage := Some(url("https://github.com/scalahub/DemoPaperWallet"))
